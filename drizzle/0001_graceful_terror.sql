...
END $$;
--> statement-breakpoint
CREATE OR REPLACE FUNCTION prevent_default_admin_deletion()
RETURNS trigger AS $$
BEGIN
  IF OLD.is_default THEN
    RAISE EXCEPTION 'The default administrator cannot be deleted';
  END IF;
  RETURN OLD;
END;
$$ LANGUAGE plpgsql;
...
FOR EACH ROW
EXECUTE FUNCTION prevent_default_admin_deletion();
